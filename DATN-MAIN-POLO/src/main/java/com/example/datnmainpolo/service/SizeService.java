...
public interface SizeService {
    SizeResponseDTO create(SizeRequestDTO requestDTO);
    SizeResponseDTO update(Integer id, SizeRequestDTO requestDTO);
    void softDelete(Integer id);
    SizeResponseDTO getById(Integer id);
    PaginationResponse<SizeResponseDTO> getAll(int page, int size);
}