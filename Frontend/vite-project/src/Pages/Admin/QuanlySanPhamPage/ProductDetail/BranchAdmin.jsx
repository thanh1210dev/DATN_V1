...
const BrandAdmin = () => {
  ...
  const fetchBrands = async () => {
    try {
      const data = await BrandService.getAll(page, size);
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Quản lý thương hiệu</h2>
        <button
          onClick={handleAdd}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-8 w-full max-w-md shadow-xl">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-5">
                <label className="block text-sm font-medium text-gray-700 mb-1">Mã thương hiệu</label>
                <input
                  type="text"
                  name="code"
                  value={formData.code}
