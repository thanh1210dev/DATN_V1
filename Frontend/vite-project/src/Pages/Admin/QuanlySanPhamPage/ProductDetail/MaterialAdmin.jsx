...
const MaterialAdmin = () => {
  ...
  const fetchMaterials = async () => {
    try {
      const data = await MaterialService.getAll(page, size);
  ...
  const handleUpdate = (material) => {
    ...
    setFormData({ code: material.code, name: material.name });
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Quản lý chất liệu</h2>
        <button
          onClick={handleAdd}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-8 w-full max-w-md shadow-xl">
            <h3 className="text-xl font-semibold mb-6 text-gray-800">
              {isEditing ? 'Cập nhật chất liệu' : 'Thêm chất liệu mới'}
            </h3>
            <form onSubmit={handleSubmit}>
              <div className="mb-5">
                <label className="block text-sm font-medium text-gray-700 mb-1">Mã chất liệu</label>
                <input
                  type="text"
                  name="code"
                  value={formData.code}
              ...
              <div className="mb-5">
                <label className="block text-sm font-medium text-gray-700 mb-1">Tên chất liệu</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
